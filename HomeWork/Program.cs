...
/*
     ...
     Не проверяйте сразу) 
    Дайте мне еще немного времени и за выходные доделаю все задачи) Постараюсь)
    Залил, чтобы потом не морочиться с тех.поддержкой)))
     А так сделал первые две задачи только. Спасибо)
